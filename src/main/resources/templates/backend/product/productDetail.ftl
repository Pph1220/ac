                ...
                <div class="container">
                    <div class="row clearfix">
                        ...
                        <div class="col-md-6 column">
                            ...
                            <label for="subtitle">标题</label><input style="width: 200px"  name="subtitle" type="text" class="form-control" id="subtitle" onchange="checkNull('subtitle')" value="${result.data.subtitle}" />
                            <label for="name">名称</label><input style="width: 200px"  name="name" type="text" class="form-control" id="name" onchange="checkNull('name')" value="${result.data.name}" />
                            <label for="price">价钱</label><input style="width: 200px"  name="price" type="text" class="form-control" id="price" onchange="checkNull('price');checkRate('price')" value="${result.data.price}" />
                            <label for="stock">库存</label><input style="width: 200px"  name="stock" type="text" class="form-control" id="stock" onchange="checkNull('stock');checkRate('stock')" value="${result.data.stock}" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row clearfix">
        ...
        <div class="col-md-10 column">
            ...
            <div class="col-md-6 column" style="text-align: right">
                <button style="display: inline-block" onclick="doDelete();" type="button" class="btn btn-default btn-danger">删除</button>
                <button style="display: inline-block" onclick="doUpdate();" type="button" class="btn btn-default btn-success">修改</button>
            </div>
        </div>
        <div class="col-md-1 column">
        </div>
